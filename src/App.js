...
// --- AYIRDIĞIMIZ MODÜLLERİ BURADA İÇERİ AKTARIYORUZ ---
...
// --- MOCK DATA OLUŞTURUCULAR VE YARDIMCI FONKSİYONLAR ---
const generateUnits = () => {
  const units = [];
  for (let i = 1; i <= 44; i++) {
...
export function StatCard({ title, amount, type, icon }) {
...
// ==========================================
// HENÜZ AYRILMAMIŞ OLAN DİĞER MODÜLLER
// ==========================================
